describe 'Transfer' do 
  ...
  describe 'Transfer - #both_valid?' do
  ...
  describe 'Transfer - #execute_transaction' do
  ...
  describe 'Transfer - #reject_transfer' do
   ...
   describe 'Transfer - #reverse_transfer' do
